...
namespace santorini_remote
{
    public class Player : PlayerInterface
    {
        ...
        public Board playerInternalBoard;

        // for player-test-harness
        public Player(string name="World")
        {
            playerName = name;
            playerInternalBoard = Board.InitBoard();
        }
        ...
        public List<List<int>> Place(Board board, string color)
        {
            this.playerColor = color;
            this.oppColor = GetOpponentColor();
        ...
        public ArrayList Play(Board board)
        {
            ...
            ArrayList possiblePlays = Strategy.PreventLoseInNTurn(board, playerColor, oppColor);
            return ChooseSmartPlay(possiblePlays);
        }

        // TODO
        // implement choosing a msart play return
        public ArrayList ChooseSmartPlay(ArrayList possiblePlays)
        {
            return (ArrayList)possiblePlays[0];
        }
